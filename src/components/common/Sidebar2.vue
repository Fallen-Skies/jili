...
<script>
    ...
    export default {
        ...
        computed: {
            onRoutes() {
                let route = this.$route.path.replace('/main2/', '');
            ...
            onDashboard2() {
                return function(item) {
                    if (item === 'main2/dashboard') {
                        return true
                    } else if (this.onRoute !== 'main2/dashboard2') {
                        return true
                    } else {
                        return false
                    }
            ...
            onDashboard2Disabled() {
                return function(item) {
                    return false
                    if (this.onRoute === 'main2/dashboard2') {
                        return true
                    } else {
                        return false
                    }
