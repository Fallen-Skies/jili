			...
			loadData() {
				if (this.shop1_activeName === "sdkltj") {
					this.shop1_qu_Arr=[
                        ...
                        [146,136,126,116,106,96,86,76,50],[104,98,90,82,74,66,58,50,32],
                        [76,70,64,58,52,46,40,34,20]
                    ];
					this.shop1_pile_Arr=[
                        ['一区','二区','三区','四区','五区','六区','七区','八区','九区'],
                        [73.5,82,73.5,80,82,90,82,80,85],
                        [26.5,18,26.5,20,18,10,18,20,15]
                    ];
					this.shop1_pileMuch_Arr=[
                        ['一区','二区','三区','四区','五区','六区','七区','八区','九区'],
                        [35,20,51,35,47,37,32,60,45],
                        [25,40,9,13,10,10,25,8,8],
                        [8,8,15,20,8,20,5,12,8],
                        [14,20,8,20,25,22,20,8,29],
                        [18,12,17,12,10,11,18,12,10]
                    ];
