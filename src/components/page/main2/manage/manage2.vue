<template>
    <div class="manage2">
        <div class="header-nav"><span>试驾申请管理</span> <i class="el-icon-arrow-right"></i>  <span>试驾车辆管理</span></div>
        ...
        <div class="body-middle">
            ...
            <div class="body-middle-chart">
                <div>
                    <h3 class="body-margin-bottom">试驾车辆列表
