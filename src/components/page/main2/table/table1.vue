			...
			<div class="body-middle-chart">
				<div>
					<div class="body-middle-flex">
						...
						<div class="col-2" style="width: 50%; border-right:0;">
							<h3>点击车型TOP3</h3>
							<div class="card-bd">
				...
				<div>
					<h3>车型数据TOP5</h3>
					<div class="table1-chart"><vChartBar :seriesArr="table1_chexing" :seriesName="'车型数据TOP5'" /></div>
				</div>
				<div>
					<h3>卖点数据TOP10</h3>
	...
	export default {
		...
		data() {
		  return {
			...
			table1_chexing:[
				{name:'领克 02',value:100},{name:'领克 01',value:90},
				{name:'领克 03',value:80},{name:'领克 01PHEV',value:70},
				{name:'领克 03+',value:60}
			],
			table1_maidian:[
