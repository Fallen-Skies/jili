            ...
            <div class='box-body model_0'>
                <ul class="model2_1-list">
                    <li v-for="(item,index) in model_1_Arr" :key="index">
                        ...
                        <div class="model_0-item-txt">
                            <div class="model_0-item-num">
                                <countTo :startVal='startVal' :endVal='model_1_endVal[index]' separator=',' ref="countTo"></countTo>{{index===2?'%':'辆'}}
                            </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            setTimeout(() => {
                this.model_1_endVal.forEach((item, index, arr) => {
                    this.$set(arr, index, this.model_1_Arr[index]["value"]);
                })
            }, 500)
