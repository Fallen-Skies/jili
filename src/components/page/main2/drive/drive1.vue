<template>
    <div class="drive1">
        <div class="header-nav"><span>试驾监测</span> <i class="el-icon-arrow-right"></i>  <span>车型试驾分析</span></div>
        ...
        data() {
            return {
                ...
                drive1_bars:[
                	...
                	[30,35,45,50,25,45,50],[20,26,35,38,16,20,26]
                ],
                ...
                drive1_linesbar: [
                    ['7.15','7.16','7.17','7.18','7.19','7.20','7.21'],
                    [138,168,130,118,172,158,130],
                    [105,110,155,160,95,105,110]
                ]
            }
        },
        mounted() {
