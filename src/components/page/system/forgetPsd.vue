        ...
        <div class="ms-login">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px" class="demo-ruleForm">
                ...
                <el-form-item prop="password">
                    <el-input type="password" placeholder="新密码" size="medium" suffix-icon="iconfont icon-mima" v-model="ruleForm.password" @keyup.enter.native="submitForm('ruleForm')"></el-input>
                </el-form-item>
                <el-form-item prop="passwordConfirm">
                    <el-input type="password" placeholder="新密码确认" size="medium" suffix-icon="iconfont icon-mima" v-model="ruleForm.passwordConfirm" @keyup.enter.native="submitForm('ruleForm')"></el-input>
                </el-form-item>
                <div class="login-btn">
